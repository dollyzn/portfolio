  ...
  return (
    ...
    >
      <SwitchThumbPrimitive
        className={cn(
          "relative z-10 bg-paper data-[checked]:bg-primary-foreground pointer-events-none block size-4 rounded-full shadow-sm ring-0",
        )}
      ...
      >
        {thumbIcon && (
          <SwitchIconPrimitive
            position="thumb"
            className="absolute [&_svg]:size-[9px] left-1/2 top-1/2 -translate-1/2 text-dim"
          >
            {thumbIcon}
          </SwitchIconPrimitive>
        )}
      ...
      {startIcon && (
        <SwitchIconPrimitive
          position="left"
          className="absolute [&_svg]:size-[9px] left-0.5 top-1/2 -translate-y-1/2 text-primary-foreground/80"
        >
          {startIcon}
        </SwitchIconPrimitive>
      )}
      {endIcon && (
        <SwitchIconPrimitive
          position="right"
          className="absolute [&_svg]:size-[9px] right-0.5 top-1/2 -translate-y-1/2 text-dim"
        >
          {endIcon}
        </SwitchIconPrimitive>
      )}
