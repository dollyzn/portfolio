...
export const contentPt: LocaleContent = {
  experiences: [
    {
  ...
  featuredProject: {
    slug: "recibo-livre",
    name: "Recibo Livre",
    tagline: "Do comprovante ao recibo de pagamento, sem sair do navegador.",
    description:
      "Você solta o PDF do comprovante, o app extrai valor, data, pagador e autenticação, e monta um recibo A4 pronto para a assinatura do Gov.br. A leitura com pdf.js e a geração do PDF acontecem no cliente: nenhum documento ou valor passa por um servidor.",
    kind: "Projeto pessoal / open source",
    features: [
      "Leitura de comprovante em PDF",
      "Preview A4 em tempo real",
      "Vários itens por recibo",
      "Exporta PDF e PNG",
      "Rascunho salvo no navegador",
      "Pronto para assinar no Gov.br",
    ],
